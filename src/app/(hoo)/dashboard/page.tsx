...
const STATUS_LABELS: Record<string, string> = { DRAFT: "Bozza", REVIEW_HM: "In attesa di consultazione", REVIEW_ADMIN: "In approvazione Accountable" };
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {/* Card 1 — In approvazione Accountable */}
        <Link href="/approvals"
          ...
          <p className="text-[12px] font-ui uppercase tracking-wider text-charcoal/50 mb-3">In approvazione Accountable</p>
      ...
      <section>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          {[
            ...
            { label: "In approvazione Accountable", value: data.kpi.sopReviewAdmin },
