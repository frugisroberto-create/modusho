...
function SidebarContent({ userName, userRole, pathname, onNavClick }: {
  userName: string; userRole: string; pathname: string; onNavClick?: () => void;
}) {
  return (
  ...
  return (
    <>
      ...
      <div className="hidden lg:block">
        <SidebarContent userName={userName} userRole={userRole} pathname={pathname} />
      </div>
      ...
      {mobileOpen && (
        <>
          ...
          <div className="lg:hidden">
            <SidebarContent userName={userName} userRole={userRole} pathname={pathname} onNavClick={() => setMobileOpen(false)} />
          </div>
        </>
      )}
    </>
